...
/**
斐波那契系列问题的递归和动态规划
https://www.nowcoder.com/practice/376282a6682a4005973cde7b3df69584?tpId=101&tqId=33251&tPage=1&rp=1&ru=/ta/programmer-code-interview-guide&qru=/ta/programmer-code-interview-guide/question-ranking
**/
...
int main()
{
    ...
    else
    {
        ...
        initMatrix(q,2,NULL);
        q=getPower(p,n-2);
        printf("%d\n",(q->elements[0][0]+q->elements[1][0])%maxn);
        destoryMatrix(p);
        destoryMatrix(q);
    }
    return 0;
