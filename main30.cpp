...
/**
斐波那契系列问题的递归和动态规划
https://www.nowcoder.com/practice/e2696bb900ce41cda8b060768e61f796?tpId=101&tqId=33253&tPage=1&rp=1&ru=/ta/programmer-code-interview-guide&qru=/ta/programmer-code-interview-guide/question-ranking
**/
...
int main()
{
    ...
    {
        long long v[]={1,1,0,0,0,1,1,0,0};
        matrix *p=NULL,*q=NULL;
        initMatrix(p,3,v);
        initMatrix(q,3,NULL);
        q=getPower(p,n-3);
        printf("%d\n",(q->elements[0][0]*3+q->elements[1][0]*2+q->elements[2][0])%maxn);
        destoryMatrix(p);
        destoryMatrix(q);
    }
    return 0;
